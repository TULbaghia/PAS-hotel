...
public class ThreeStarNegativeTests {
    ...
    public void ThreeStarAddFailureTest() {
        ...
        given().contentType(ContentType.JSON)
                ...
                .then()
                .assertThat()
                .body("errorMessage[0].message", containsString("JSONObject[\"bonus\"] not found."))
                .statusCode(400);
    }
}
